...
<div class="w3layouts-main">
	<h2>Đăng Nhập</h2>
		...
		<form action="{{URL::to('/admin-dashboard')}}" method="post"> <!-- admin-dashboard: hàm này tự truy cập đến cơ sở dữ liệu admin_tbl -->
			...
			<span><input type="checkbox" name="remember"/>Nhớ đăng nhập</span>
			<h6><a href="{{URL::to('/forget-password')}}">Quên mật khẩu?</a></h6>
