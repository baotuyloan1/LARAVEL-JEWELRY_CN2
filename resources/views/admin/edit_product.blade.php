                        ...
                        @foreach($edit_product as $key =>$edit)
                            ...
                            <form role="form" action="{{URL::to('/update-product/'.$edit->product_id)}}" method="post" enctype = "multipart/form-data" > 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='discount_product' class="form-control input-sm m-bot15">
                                        @foreach($discount_product as $key => $disc)
                                            @if($disc->discount_id == $edit->discount_id)
                                            <option selected value ='{{$disc->discount_id}}'>{{$disc->discount_name}}({{$disc->discount_object}})</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"  value="{{$edit->product_image}}" class="form-control" name="product_image" id="text" >
